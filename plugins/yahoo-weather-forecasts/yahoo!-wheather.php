...
function yahoo_weather_simplepie( $woeid, $temperature = 'c', $show_credit = true ) {
	...
	if( function_exists('fetch_feed') ) {
		...
		// return $content;
		// Modificacion para obtener todos los datos del clima - EZEQUIEL
		$array["temperatura"] = $weather->get_temperature();
		$array["humedad"] = $weather->get_humidity();
		$array["fecha"] = date("d/n");
		$array["unidadTemp"] = $weather->get_units_temp();
